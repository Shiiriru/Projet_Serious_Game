...
public class MsgGoodVariableSourceMng : VariableSourceManager, IMsgGoodVariableSource
{
    [SerializeField] ScriptMsg soldatmsgScript;
    ...
    {
        soldatmsgScript.EnvoieMsg(index);
    }
}
